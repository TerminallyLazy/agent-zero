...
class Settings(TypedDict):
    ...
    canvas_enabled: bool
    canvas_headless: bool
    canvas_auto_reload: bool
...
def get_default_settings() -> Settings:
    return Settings(
        ...
        canvas_enabled=get_default_value("canvas_enabled", True),
        canvas_headless=get_default_value("canvas_headless", True),
        canvas_auto_reload=get_default_value("canvas_auto_reload", True),
        variables="",
        secrets="",
