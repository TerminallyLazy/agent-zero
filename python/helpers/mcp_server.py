    ...
    def reconfigure(self, token: str):
        ...
        with self._lock:
            self.app = create_sse_app(
                server=mcp_server,
Okay                message_path=fastmcp.message_path,
                sse_path=fastmcp.sse_path,
                # auth_server_provider=fastmcp.server.auth_server_provider,
                # auth_settings=fastmcp.server.auth_settings,
                # debug=fastmcp.server.debug,
                # routes=fastmcp,
